    ...
    (t.prototype.respChart = function (e, r, a, o) {
        ...
        (t.prototype.initCharts = function () {
            if (0 < l("#high-performing-product").length) {
                var t = document.getElementById("high-performing-product").getContext("2d").createLinearGradient(0, 500, 0, 150);
                ...
                var e = {
                    ...
                    datasets: [
                        ...
                        { label: "Revenue", backgroundColor: "#e3eaef", borderColor: "#e3eaef", hoverBackgroundColor: "#e3eaef", hoverBorderColor: "#e3eaef", data: [89, 40, 32, 65, 59, 80, 81, 56, 89, 40, 65, 59] },
                    ],
                };
                [].push(
